...
\usepackage{float}
% Carátula: se incrusta caratula.pdf como primera página desde el propio .tex,
% de modo que se regenere en cada compilación (reproducible al clonar el repo).
\usepackage{pdfpages}
...
% ── Carátula (datos de identificación, URL del repositorio en una sola
%    línea y capturas del cuestionario del SGA) ──────────────────────
